...
export default function HalftoneGenerator() {
  ...
  return (
    <div className="h-full w-full flex">
      {/* Left Navigation */}
      <div className="w-64 flex-none bg-[#0A0A0B] border-r border-[#1F2937]/10">
        {/* Header */}
        <div className="h-14 px-4 flex items-center border-b border-[#1F2937]/10">
        ...
        <div className="h-[calc(100vh-3.5rem)] overflow-y-auto">
          ...
          {/* Actions */}
          <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-[#1F2937]/10 bg-[#0A0A0B]">
